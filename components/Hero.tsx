...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-start sm:justify-center items-center overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center flex flex-col items-center pt-32 sm:pt-0">
        ...
        {/* Subheadline */}
        <p className="text-sm sm:text-base md:text-lg text-white font-light mb-6 sm:mb-12 tracking-wide drop-shadow-lg max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
      ...
      {/* Logos Footer */}
      <div className="absolute bottom-48 sm:bottom-20 left-0 right-0 z-10 px-4 sm:px-6 animate-fade-in" style={{ animationDelay: '0.5s' }}>
