  ...
  return (
    <section className="bg-black py-24 border-t border-white/5">
      <div className="container mx-auto px-6">
        <h2 className="font-serif text-4xl md:text-5xl text-center text-white mb-16">Hear from Zeba's clients</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card 1 */}
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-8 md:p-12 hover:border-white/20 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-white font-medium">Sean Rad</h4>
                <p className="text-gray-500 text-sm">Former CEO of Tinder</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-8 md:p-12 hover:border-white/20 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-white font-medium">Dan Westgarth</h4>
                <p className="text-gray-500 text-sm">COO at Deel</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-8 md:p-12 hover:border-white/20 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-white font-medium">Shane Selinger</h4>
                <p className="text-gray-500 text-sm">CEO at GameGrid</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-8 md:p-12 hover:border-white/20 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-white font-medium">Nathan Sumekh</h4>
                <p className="text-gray-500 text-sm">COO at LegalSoft</p>
              </div>
            </div>
          </div>
